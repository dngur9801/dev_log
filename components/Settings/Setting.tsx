...
const Setting = () => {
  ...
  const [isModifySubject, setIsModifySubject] = useState<boolean>(false);
  const [nickname, setNickname] = useState<string>('asdsdfas');
  const [introduce, setIntroduce] = useState<string>('bbbbbbbbb');
  const [subject, setSubject] = useState<string>('dngur9801');
